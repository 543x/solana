...
rent is a bit of a misnomer since it never actually gets
...
[the Solana documentation](https://solana.com/docs/intro/rent).
...
This lab was created with Anchor version `0.28.0` in mind.
